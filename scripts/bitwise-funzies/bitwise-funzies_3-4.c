...
// Print a long as a binary number
// Second arg is how many bits to print; 0 means size of long.
void binaryprintf(unsigned long number, int len) {
    ...
    // Print sizeof(long)
    printf("Your sizeof(long) for the above number was %lu.\nThis datatype allows us to express numbers from %ld to %ld .\n", sizeof(long), LONG_MIN, LONG_MAX);
}
